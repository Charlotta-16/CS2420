...
bool checkTest(const string& testName, const string& whatItShouldBe, const string& whatItIs);
bool checkTest(const string& testName, int whatItShouldBe, int whatItIs);
bool checkTestMemory(const string& testName, int whatItShouldBe, int whatItIs);
